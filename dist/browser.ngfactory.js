...
var import1 = require("./browser");
var import2 = require("./transfer-state");
var BrowserTransferStateModuleInjector = (function (_super) {
    ...
    Object.defineProperty(BrowserTransferStateModuleInjector.prototype, "_APP_INITIALIZER_2", {
        get: function () {
            if ((this.__APP_INITIALIZER_2 == null)) {
                (this.__APP_INITIALIZER_2 = [import1.getTransferInitializer(this._TransferState_1)]);
            }
...
exports.BrowserTransferStateModuleNgFactory = new import0.NgModuleFactory(BrowserTransferStateModuleInjector, import1.BrowserTransferStateModule);
