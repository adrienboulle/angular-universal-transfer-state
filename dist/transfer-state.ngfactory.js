...
var import1 = require("./transfer-state");
    ...
    Object.defineProperty(TransferHttpModuleInjector.prototype, "_TransferHttp_1", {
        get: function () {
            if ((this.__TransferHttp_1 == null)) {
                (this.__TransferHttp_1 = new import1.TransferHttp(this.parent.get(import2.Http), this.parent.get(import1.TransferState)));
            }
...
exports.TransferHttpModuleNgFactory = new import0.NgModuleFactory(TransferHttpModuleInjector, import1.TransferHttpModule);
//# sourceMappingURL=transfer-state.ngfactory.js.map